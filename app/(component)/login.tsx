                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        <div className="flex flex-col space-y-2">
                            <Button variant="outline" onClick={() => signIn('google', {callbackUrl: 'https://secure.s24.ierg4210.ie.cuhk.edu.hk'})}>
                            ...
                            <Button onClick={() => signIn('github', {callbackUrl: 'https://secure.s24.ierg4210.ie.cuhk.edu.hk'})}>
